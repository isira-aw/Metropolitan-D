...
export const MyTasks: React.FC = () => {
  ...
  const [updatingTask, setUpdatingTask] = useState<MiniJobCardResponse | null>(
    null
  );
  ...
  if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          setUpdateForm(prev => ({
            ...prev,
            location: `${latitude}, ${longitude}`, // You can format this however you'd like
          }));
        },
        (error) => {
          console.error('Error getting location', error);
          // Handle error, e.g., if geolocation is denied or not available
        }
      );
    } else {
          ...
          >
            ...
            <div className="space-y-2">
              {task.status === "PENDING" && (
                <button
                  onClick={() =>
                    quickStatusUpdate(task.miniJobCardId, "IN_PROGRESS")
                  }
              ...
              {task.status === "IN_PROGRESS" && (
                <button
                  onClick={() =>
                    quickStatusUpdate(task.miniJobCardId, "COMPLETED")
                  }
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setUpdateForm((prev) => ({ ...prev, location: e.target.value }))
              }
              className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setUpdateForm((prev) => ({ ...prev, time: e.target.value }))
                }
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
